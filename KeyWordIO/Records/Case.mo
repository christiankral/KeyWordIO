...
record Case "Case CSV record containing header string, margin string and numerical data array"
  ...
  parameter String headerString[header,colMax] "Header string array";
  parameter String marginString[rowMax-header,margin] "Margin string array";
