...
model ReadRealParameter "Reads real parameters from file"
  ...
  parameter Modelica.Units.SI.Resistance R0=KeyWordIO.readRealParameter(
      inputFileName, "R0");
  parameter Modelica.Units.SI.Resistance R1=KeyWordIO.readRealParameter(
      inputFileName, "R1");
  parameter Modelica.Units.SI.Resistance R2=KeyWordIO.readRealParameter(
      inputFileName, "R2");
