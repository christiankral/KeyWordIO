...
model ElectricalCases "Read case record from CSV file"
  ...
  parameter String fileName = Modelica.Utilities.Files.loadResource("modelica://KeyWordIO/Resources/case_long.csv");
  ...
  KeyWordIO.Examples.CaseExamples.Electrical electrical[cases](
    Vrms = KeyWordIO.readCaseCol(fileName=fileName,header=header,margin=margin,cache=true,name="Vrms"),
    phiv = Modelica.SIunits.Conversions.from_deg(KeyWordIO.readCaseCol(fileName=fileName,header=header,margin=margin,cache=true,name="phiv")),
    f = KeyWordIO.readCaseCol(fileName=fileName,header=header,margin=margin,cache=true,name="f"),
    R = KeyWordIO.readCaseCol(fileName=fileName,header=header,margin=margin,cache=true,name="R"),
    L = KeyWordIO.readCaseCol(fileName=fileName,header=header,margin=margin,cache=true,name="L"))
